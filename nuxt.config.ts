...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    public: {
      ...
      stripeCoachingZenProductId: process.env.NUXT_PUBLIC_STRIPE_COACHING_ZEN_PRODUCT_ID || '',
      stripeCoachingZenPriceId: process.env.NUXT_PUBLIC_STRIPE_COACHING_ZEN_PRICE_ID || '',
      stripeCoachingExpressProductId: process.env.NUXT_PUBLIC_STRIPE_COACHING_EXPRESS_PRODUCT_ID || '',
      stripeCoachingExpressPriceId: process.env.NUXT_PUBLIC_STRIPE_COACHING_EXPRESS_PRICE_ID || '',
